...
public class UpdateMedicine extends javax.swing.JFrame {
    ...
    public UpdateMedicine(String tempName){
        initComponents();
        username = tempName;
    ...
    private void initComponents() {
        ...
        txtLijek = new javax.swing.JTextField();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtProizvodjac, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                        .addComponent(txtNoviNaziv, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txtATC, javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(txtLijek, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jButton2))
                        .addGap(46, 46, 46)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String id = txtLijek.getText();
        try{
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM lijek WHERE id = '"+id+"' ");
            if(rs.next()){
                do{
                    txtNoviNaziv.setText(rs.getString("naziv"));
                    txtATC.setText(rs.getString("atc_sifra"));
                    txtCijena.setText(rs.getString("cijena"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            String naziv = txtNoviNaziv.getText();
            ...
            int kolicina = Integer.parseInt(txtKolicina.getText());
             ...
             if(atc.equals("")){
                ...
                try{
                    Connection con = ConnectionProvider.getCon();
                    PreparedStatement st = con.prepareStatement("UPDATE `lijek` SET `naziv` = ?,`cijena` = ?, `proizvodjac` = ?, `atc_sifra` = ?, `na_stanju` = ? WHERE `id` = ?");
                    st.setString(1, naziv);
                    st.setFloat(2, cijena);
                    st.setString(3, proizvodjac);
                    st.setString(4, atc);
                    ...
                    setVisible(false);
                    new PharmacistDashboard(username).setVisible(true);
                    JOptionPane.showMessageDialog(null, "Promjena na lijeku je sačuvana!");
    ...
    private javax.swing.JTextField txtLijek;
